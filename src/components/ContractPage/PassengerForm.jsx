...
export const Passengers = ({ guestCount = 1, formData, handleInputChange }) => {
    return (
                ...
                <div key={index} className="border border-[#C5C5C5] p-4 rounded-xl shadow-sm">
                    ...
                    <div className="flex flex-col gap-4 mt-3">
                        ...
                        <div>
                            ...
                            <div className="flex items-center gap-3  flex-col md:flex-row  mt-1">
                                <label className="flex items-center gap-2 border border-[#C5C5C5]  px-4 py-2 rounded-2xl cursor-pointer">
                                    <input
                                        type="checkbox"
                                        className="accent-white"
                                        value={formData.passengerInfo[index]?.isDrivingLicense}
                                        checked={formData.passengerInfo[index]?.isDrivingLicense}
                                        onChange={(e) => handleInputChange(index, 'isDrivingLicense', e.target.checked)}
                                    />
                                ...
                                <input
                                    ...
                                    onChange={(e) => handleInputChange(index, 'drivingLicenseNumber', e.target.value)}
                                />
                            </div>
                        </div>
